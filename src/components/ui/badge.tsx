...
export function Badge({
  ...
  const bgVar = color === 'blue' ? 'var(--color-primary-50)' : `var(--${color}-bg)`;
  const textVar = color === 'blue' ? 'var(--color-primary-700, #1d4ed8)' : `var(--${color}-text)`;
  const dotColor = color === 'blue' ? 'var(--color-primary)' : `var(--${color}-text)`;
