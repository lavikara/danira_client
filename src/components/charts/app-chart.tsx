...
import { Chart as ChartJS, BarElement, LineElement, PointElement, ArcElement,
  RadialLinearScale, LinearScale, CategoryScale, Filler, Tooltip, Legend } from "chart.js";
import type { ChartOptions, ChartData } from "chart.js";
import { useTheme } from "@/contexts/theme-context";

ChartJS.register(BarElement, LineElement, PointElement, ArcElement,
  RadialLinearScale, LinearScale, CategoryScale, Filler, Tooltip, Legend);
  ...
  if (!mounted) {
    return (
      <div style={wrapperStyle}
        className="animate-pulse rounded-lg bg-border-light" />
    );
  }
