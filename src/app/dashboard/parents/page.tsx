              ...
              <Table>
                ...
                <TBody>
                  {PARENTS.map((p, i) => (
                    <TR key={p.name}>
                      <TD>
                        <NameCell name={p.name} sub={p.phone} index={i + 2} />
                      </TD>
                      ...
                      <TD>
                        <Badge color={p.fee === 'Paid' ? 'green' : 'orange'}>{p.fee}</Badge>
                      </TD>
                      <TD>
                        <ActionButtons />
                      </TD>
                ...
                <CardBody className="py-2">
                  {TODAYS_MEETINGS.length === 0 ? (
                    ...
                    TODAYS_MEETINGS.map((m, i) => (
                      <div
                        key={m.name}
                        className="flex gap-2.5 border-b border-border-light py-2.5 last:border-b-0"
                      >
                        <div
                        ...
                        <div>
                          ...
                          <div className="mt-0.5 text-[11px] text-t3">
                            <i className="bi bi-clock" /> {m.time} today
                          </div>
                        </div>
                      </div>
                    ))
