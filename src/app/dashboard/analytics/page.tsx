    ...
    <div className="min-w-0">
      ...
      {isEmpty ? (
        ...
        <>
                ...
                <AppChart
                  ...
                  data={{
                    ...
                    datasets: [
                      {
                        label: 'JSS',
                        data: YEARLY_ENROLLMENT.jss,
                        backgroundColor: '#2563EB',
                        borderRadius: 6,
                      },
                      {
                        label: 'SS',
                        data: YEARLY_ENROLLMENT.ss,
                  ...
                  options={{
                    plugins: {
                      legend: {
                        display: true,
                        position: 'bottom',
                        labels: { boxWidth: 9, font: { size: 11 } },
                      },
                    },
                  }}
                />
                ...
                <AppChart
                  ...
                  data={{
                    ...
                    datasets: [
                      {
                        label: 'School',
                        data: ACADEMIC_PERFORMANCE.school,
                        borderColor: '#2563EB',
                        fill: false,
                        tension: 0.4,
                        borderWidth: 2,
                      ...
                      {
                        label: 'State Avg',
                        data: ACADEMIC_PERFORMANCE.state,
                        borderColor: '#94A3B8',
                        fill: false,
                        tension: 0.4,
                        borderWidth: 2,
              ...
              <CardBody>
                <AppChart
                  ...
                  data={{
                    ...
                    datasets: [
                      {
                        data: GRADE_DISTRIBUTION.data,
                        backgroundColor: GRADE_DISTRIBUTION.colors,
                        borderRadius: 5,
                      },
                    ],
                  }}
          ...
          <div className="rounded-2xl bg-linear-to-br from-[#0F172A] to-[#1e3a8a] p-5 text-white">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {AI_INSIGHTS.map((insight) => (
                <div key={insight.title} className="rounded-xl bg-white/6 p-4">
