    ...
    <div className="animate-pulse">
      ...
      <div className="mb-5 grid grid-cols-2 gap-[15px] sm:grid-cols-3 lg:grid-cols-6">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="h-[130px] rounded-2xl border border-border-light bg-surface p-4">
      ...
      <div className="grid grid-cols-1 gap-[18px] lg:grid-cols-[1.5fr_1fr]">
        <div className="h-[320px] rounded-2xl border border-border-light bg-surface p-5">
          <div className="h-4 w-40 rounded-md bg-border-light" />
          <div className="mt-6 h-[230px] rounded-md bg-border-light" />
        </div>
        <div className="h-[320px] rounded-2xl border border-border-light bg-surface p-5">
